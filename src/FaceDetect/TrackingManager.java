...
public class TrackingManager extends Thread {
	...
	public TrackingManager(String mode, Webcam camera, double sensitivity, int trackRate) {
		
		System.out.println("Setting Up Tracking Manager");
		
		System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
		
		objectDetector = new CascadeClassifier(
				"C:/Program Files (x86)/eclipse/OpenCV/bin/" + mode);
